...
function add_style_sheets() {
	if( !is_admin() ) {
		...
		wp_enqueue_style( 'lity', get_template_directory_uri().'/assets/css/lity.less', 'screen' );
...
function add_javascript() {
	...
	wp_enqueue_script( 'lity', get_template_directory_uri().'/assets/js/lity.js', array('jquery'), null, true );
	wp_enqueue_script( 'general', get_template_directory_uri().'/assets/js/general.js', array('slick', 'lity'), null, true );
